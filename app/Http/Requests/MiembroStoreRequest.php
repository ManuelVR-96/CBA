...
class MiembroStoreRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'seguridad'=> ['string','alpha', 'max:40'],
            'primer_acudiente'=> ['string', 'max:40'],
            'segundo_acudiente'=> ['string', 'max:40'],
            'servicio_funerario' => ['string', 'max:2'],
            'entidad_funeraria' => ['string','max:40'],
            'dependencia_economica'=> ['string', 'max:40'] ,
            'dependencia_afectiva'=> ['string', 'max:40'],
            'relacion_familiar'=> ['string', 'max:40'],
            'hobbies'=>['string', 'max:250'],
            'motivo_ingreso'=>['string', 'max:250'],
            'tipo_sangre'=>['required','string', 'max:5'],
            'eps'=> ['string', 'max:20'],
            'morbilidad'=>['string', 'max:250'],
            'genero'=>['required', 'string','alpha', 'max:250'],
            'medicinas'=>['string', 'max:250'],
