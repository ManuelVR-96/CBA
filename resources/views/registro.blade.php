...
<div class="container">
    <form enctype="multipart/form-data" method="POST" action="{{route('miembros.store')}}" class="form">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <label for="telefono" class="col-md-3 col-form-label">{{ __('Teléfono') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="lugar" class="col-md-3 col-form-label">{{ __('Lugar de Nacimiento') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="seguridad" class="col-md-3 col-form-label">{{ __('Seguridad Social') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="primer_acudiente" class="col-md-3 col-form-label">{{ __('Primer Acudiente') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="segundo_acudiente" class="col-md-3 col-form-label">{{ __('Segundo Acudiente') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="servicio_funerario" class="col-md-3 col-form-label">{{ __('Servicio Funerario') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="entidad_funeraria" class="col-md-3 col-form-label">{{ __('Entidad Funeraria') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="dependencia_economica" class="col-md-3 col-form-label">{{ __('Dependencia Económica') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="dependencia_afectiva" class="col-md-3 col-form-label">{{ __('Dependencia Afectiva') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="relacion_familiar" class="col-md-3 col-form-label">{{ __('Relación Familiar') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="hobbies" class="col-md-3 col-form-label">{{ __('Hobbies') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="motivo_ingreso" class="col-md-3 col-form-label">{{ __('Motivo Ingreso') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="tipo_sangre" class="col-md-3 col-form-label">{{ __('Tipo Sangre') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="eps" class="col-md-3 col-form-label">{{ __('EPS') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="morbilidad" class="col-md-3 col-form-label">{{ __('Morbilidad') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="genero" class="col-md-3 col-form-label">{{ __('Género') }}</label>
                <div class="col-md-8">
            ...
            <div class="form-group row">
                <label for="medicinas" class="col-md-3 col-form-label">{{ __('Medicinas') }}</label>
                <div class="col-md-8">
