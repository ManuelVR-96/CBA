                ...
                <div class="card-body">
                    <form method="POST" action="{{route('miembros.store')}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <Textarea id="hobbies" type="text" class="form-control @error('hobbies') is-invalid @enderror" name="hobbies" value="{{ old('hobbies') }}" autofocus></Textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <Textarea id="motivo_ingreso" type="text" class="form-control @error('motivo_ingreso') is-invalid @enderror" name="motivo_ingreso" value="{{ old('motivo_ingreso') }}" autofocus></Textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                              <select name="genero" class="form-control @error('genero') is-invalid @enderror" value="{{ old('genero') }}" name="genero" type="textp">>
                                  <option value="NULL">--Seleccione--</option>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <Textarea id="medicinas" type="text" class="form-control @error('medicinas') is-invalid @enderror" name="medicinas" value="{{ old('medicinas') }}" autofocus></Textarea>
