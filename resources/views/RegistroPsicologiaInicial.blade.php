...
<div class="container">
    <form method="POST" class="form" action="{{route('psico_inicial.store')}}">
        <div class="card-header form-tittle_">Registro Test Psicológico de:  {{$nuevoCliente->nombres}} {{$nuevoCliente->apellidos}}</div>
        @csrf
        ...
        <div class="form-group row">
            <label for="yesavage_seis" class="col-md-7 col-form-label">{{ __('¿Teme que algo malo pueda ocurrirle?') }}</label>
            <div class="col-md-5">
        ...
        <div class="form-group row">
            <label for="autoestima_diez" class="col-md-7 col-form-label">{{ __('Tengo una visión positiva sobre si mismo/a.') }}</label>
            <div class="col-md-5">
