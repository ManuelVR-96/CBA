     ...
     <div class="panel panel-default">
          <div class="panel-body">
               ...
               <div class="form-group row">
                    ...
                    <div class="dropdown">                    
                         <a href= "{{ url('valoraciones/create/'.$user->id) }}" class="btn btn-primary">Agregar nueva Valoración</a>
                         <a href= "{{ url('miembros/'.$user->id.'/edit') }}" class="btn btn-primary">Editar información del paciente</a>
                         <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">Valoraciones Iniciales
