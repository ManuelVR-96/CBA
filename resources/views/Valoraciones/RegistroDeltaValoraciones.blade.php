...
<div class="container">
    <form method="POST" class="form" action="{{route('delta.update', $nuevoCliente->id)}}">
        ...
        <div class="card-body">
            ...
            <div class="form-group row">
                <label for="encargado" class="col-md-5 col-form-label">{{ __('Encargado Enfermeria') }}</label>
                <div class="col-md-7">                
                    <select id="encargado_enfermeria" type="text" class="form-control @error('encargado_enfermeria') is-invalid @enderror" name="encargado_enfermeria" value="{{ $delta->encargado_enfermeria }}" autofocus>
                        <option value="null">Seleccione</option>
                        @foreach($encargados as $encargado)
                        <option value="{{$encargado->id}}">{{$encargado->nombres}}</option>
                        @endforeach()
                        @error('encargado_enfermeria')
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="dependencia_movilizacion" type="integer" class="form-control @error('dependencia_movilizacion') is-invalid @enderror" value="{{ $delta->dependencia_movilizacion }}">
                        <option value="{{ $delta->dependencia_movilizacion}}">{{ $delta->dependencia_movilizacion }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="dependencia_deambulacion" type="integer" class="form-control @error('dependencia_deambulacion') is-invalid @enderror" value="{{ $delta->dependencia_deambulacion }}">
                        <option value="{{ $delta->dependencia_deambulacion }}">{{ $delta->dependencia_deambulacion }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="dependencia_aseo" type="integer" class="form-control @error('dependencia_aseo') is-invalid @enderror" value="{{ $delta->dependencia_aseo }}">
                        <option value="{{ $delta->dependencia_aseo}}">{{ $delta->dependencia_aseo }}</option>
                        <option value=0>(0)	Autónomo</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="dependencia_vestido" type="integer" class="form-control @error('dependencia_vestido') is-invalid @enderror" value="{{ $delta->dependencia_vestido }}">
                        <option value="{{ $delta->dependencia_vestido }}">{{ $delta->dependencia_vestido }}</option>
                        <option value=0>(0)	Autónomo</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="dependencia_alimentacion" type="integer" class="form-control @error('dependencia_alimentacion') is-invalid @enderror" value="{{ $delta->dependencia_alimentacion}}">
                        <option value="{{ $delta->dependencia_alimentacion }}">{{ $delta->dependencia_alimentacion }}</option>
                        <option value=0>(0)	Autónomo</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="dependencia_esfinteriana" type="integer" class="form-control @error('dependencia_esfinteriana') is-invalid @enderror" value="{{ $delta->dependencia_esfinteriana }}">
                        <option value="{{ $delta->dependencia_esfinteriana }}">{{ $delta->dependencia_esfinteriana}}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="dependencia_tratamientos" type="integer" class="form-control @error('dependencia_tratamientos') is-invalid @enderror" value="{{ $delta->dependencia_tratamientos}}">
                        <option value="{{ $delta->dependencia_tratamientos }}">{{ $delta->dependencia_tratamientos }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="cuidados_enfermeria" type="integer" class="form-control @error('cuidados_enfermeria') is-invalid @enderror" value="{{ $delta->cuidados_enfermeria }}">
                        <option value="{{ $delta->cuidados_enfermeria }}">{{ $delta->cuidados_enfermeria }}</option>
            ...
            <div class="form-group row">
                <label for="necesidad_vigilancia" class="col-md-5 col-form-label">{{ __('Necesidad de Vigilancia') }}</label>
                <div class="col-md-7">
                    <select name="necesidad_vigilancia" type="integer" class="form-control @error('necesidad_vigilancia') is-invalid @enderror" value="{{ $delta->necesidad_vigilancia }}">
                        <option value="{{ $delta->necesidad_vigilancia }}">{{ $delta->necesidad_vigilancia }}</option>
                        <option value=0>(0)	No precisa.</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="colaboracion" type="integer" class="form-control @error('colaboracion') is-invalid @enderror" value="{{ $delta->colaboracion }}">
                        <option value="{{ $delta->colaboracion }}">{{ $delta->colaboracion }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <Textarea id="descripcion_dependencia" type="text" class="form-control @error('descripcion_dependencia') is-invalid @enderror" name="descripcion_dependencia" value="{{ $delta->descripcion_dependencia }}"></textarea>
            ...
            <div class="form-group row">
                <label for="encargado" class="col-md-5 col-form-label">{{ __('Encargado Enfermeria') }}</label>
                <div class="col-md-7">            
                    <select id="encargado_fisica" type="text" class="form-control @error('encargado_fisica') is-invalid @enderror" name="encargado_fisica" value="{{ $delta->encargado_fisica }}"  autofocus>
                        <option value="{{$delta->encargado_fisica}}">Seleccione</option>
                        @foreach($encargados as $encargado)
                        <option value="{{$encargado->id}}">{{$encargado->nombres}}</option>
                        @endforeach()
                        @error('encargado_fisica')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
                        @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="fisica_estabilidad" type="integer" class="form-control @error('fisica_estabilidad') is-invalid @enderror" value="{{ $delta->fisica_estabilidad }}">
                        <option value="{{ $delta->fisica_estabilidad }}">{{ $delta->fisica_estabilidad }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="vision_audicion" type="integer" class="form-control @error('vision_audicion') is-invalid @enderror" value="{{ $delta->vision_audicion }}">
                        <option value="{{ $delta->vision_audicion }}">{{ $delta->vision_audicion }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="fisica_locomotor" type="integer" class="form-control @error('fisica_locomotor') is-invalid @enderror" value="{{ $delta->fisica_locomotor }}">
                        <option value="{{ $delta->fisica_locomotor }}">{{ $delta->fisica_locomotor }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="fisica_neurologicas" type="integer" class="form-control @error('fisica_neurologias') is-invalid @enderror" value="{{ $delta->fisica_neurologicas }}">
                        <option value="{{ $delta->fisica_neurologicas }}">{{ $delta->fisica_neurologicas }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="fisica_cardiovascular" type="integer" class="form-control @error('fisica_cardiovascular') is-invalid @enderror" value="{{ $delta->fisica_cardiovascular}}">
                        <option value="{{ $delta->fisica_cardiovascular }}">{{ $delta->fisica_cardiovascular }}</option>
                        <option value=0>(0)	Sin alteraciones.</option>
            ...
            <div class="form-group row">
                <label for="encargado" class="col-md-5 col-form-label">{{ __('Encargado Psíquica') }}</label>
                <div class="col-md-7">            
                    <select id="encargado_psiquica" type="text" class="form-control @error('encargado_psiquica') is-invalid @enderror" name="encargado_psiquica" value="{{ $delta->encargado_psiquica }}" required autocomplete="encargado_enfermeria" autofocus>
                        <option value="null">Seleccione</option>
                        @foreach($encargados as $encargado)
                        <option value="{{$delta->encargado_psiquica}}">{{$delta->encargado_psiquica}}</option>
                        @endforeach()
                        @error('encargado_psiquica')
                            <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                            </span>
                        @enderror
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="lenguaje_comprension" type="integer" class="form-control @error('lenguaje_comprension') is-invalid @enderror" value="{{ $delta->lenguaje_compresion }}">
                        <option value="{{ $delta->lenguaje_comprension }}">{{ $delta->lenguaje_comprension }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="orientacion_memoria" type="integer" class="form-control @error('orientacion_memoria') is-invalid @enderror" value="{{ $delta->orientacion_memoria }}">
                        <option value="{{ $delta->orientacion_memoria }}">{{ $delta->orientacion_memoria }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="trastorno_comportamiento" type="integer" class="form-control @error('fisica_locomotor') is-invalid @enderror" value="{{ $delta->fisica_locomotor }}">
                        <option value="{{ $delta->trastorno_comportamiento }}">{{ $delta->trastorno_comportamiento }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="capacidad_juicio" type="integer" class="form-control @error('capacidad_juicio') is-invalid @enderror" value="{{ $delta->capacidad_juicio }}">
                        <option value="{{ $delta->capacidad_juicio }}">{{ $delta->capacidad_juicio }}</option>
            ...
            <div class="form-group row">
                ...
                <div class="col-md-7">
                    <select name="alteracion_sueño" type="integer" class="form-control @error('alteracion_sueño') is-invalid @enderror" value="{{ $delta->alteracion_sueño}}">
                        <option value="{{ $delta->alteracion_sueño }}">{{ $delta->alteracion_sueño }}</option>
