...
@section('content')
    ...
    <div class="container box">
        <form method="POST" class="form" action="{{route('fisio_inicial.store')}}"> 
            <div class="card-header form-tittle_">Valoracion Fisioterapia de: {{$nuevoCliente->nombres}} {{$nuevoCliente->apellidos}}</div><br>
            <div class="card-header form-tittle_">Realizado por: {{$fisio_inicial->encargado_->nombres}} {{$fisio_inicial->encargado_->apellidos }}</div>
            <fieldset disabled>
                @csrf  
                <div>
                ...
                <div class="form-group row">
                    <label for="marcha_observaciones" class="col-md-5 col-form-label">{{ __('Observaciones marcha') }}</label>
                    <div class="col-md-7">
                ...
                <div class="form-group row">
                    <label for="diagnostico_fisioterapeutico" class="col-md-5 col-form-label">{{ __('Diagnóstico fisioterapéutico' ) }}</label>
                    <div class="col-md-7">
