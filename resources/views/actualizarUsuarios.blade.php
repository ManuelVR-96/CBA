                ...
                <div class="card-body">
                    ...
                    @method('PUT')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="id" type="text" class="form-control @error('id') is-invalid @enderror" name="id" required autocomplete="id" value="{{$usuario->cedula}}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select name="nivel" class="form-control @error('nivel') is-invalid @enderror" value= name="nivel">>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <Textarea id="formacion" type="text" class="form-control @error('formacion') is-invalid @enderror" name="formacion" value="{{$usuario->formación}}" required autocomplete="formacion" autofocus>{{$usuario->formación}}</textarea>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="cargo" type="text" class="form-control @error('cargo') is-invalid @enderror" name="cargo" value="{{$usuario->cargo}}" required autocomplete="cargo" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="direccion" type="text" class="form-control @error('direccion') is-invalid @enderror" name="direccion" value="{{$usuario->dirección}}" required autocomplete="direccion" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="telefono" type="integer" class="form-control @error('telefono') is-invalid @enderror" name="telefono" value="{{$usuario->telefono}}" required autocomplete="telefono" autofocus>
