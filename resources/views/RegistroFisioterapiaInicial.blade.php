...
@section('content')
    ...
    <div class="container box">     
        <form method="POST" class="form" action="{{route('lista_nombres')}}">
        <div class="form-header"><h1 class="form-tittle">{{ __('Registro Valoración Fisioterapia') }}</h1></div>
        @csrf  
        ...
        <div class="form-header2"><h1 class="form-tittle2">{{ __('2. VALORACIÓN') }}</h1><h1 class="form-tittle2">{{ __('2.1 Alerta Atención Y Cognición') }}</h1></div><br>             
        <div class="form-group row">
        ...
        <div class="form-header2"><h1 class="form-tittle2">{{ __('2.2 Dolor') }}</h1></div>
        <div class="form-group row">
        ...
        <div class="form-header2"><h1 class="form-tittle2">{{ __('2.3 Screening Articular') }}</h1></div>    
        ...
        <div class="form-header2"><h1 class="form-tittle2">{{ __('2.4 Screening Muscular') }}</h1></div>    
        <div class="table-responsive">                    
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                ...
                <tbody>                           
                    ...
                    <tr>                            
                        <td scope="col">Extensores de codo</td>
                        <td scope="col">Mantenga los brazos a los lados del tronco, codos flexionados a 90, antebrazos en neutro, sostenga.</td>
                        <td scope="col">Intente empujar los  brazos hacia el cuerpo  en rotación externa.</td>
                        <td scope="col"><input id="rotadores_laterales_hombro" type="integer" class="form-control @error('rotadores_laterales_hombro') is-invalid @enderror" name="rotadores_laterales_hombro" value="{{ old('rotadores_laterales_hombro') }}" ></td>                   
                    </tr>
        ...
        <div class="form-header2"><h1 class="form-tittle2">{{ __('3. FUERZA MUSCULAR') }}</h1></div>
        <div class="form-group row">
            <label for="escala_fuerza_muscular" class="col-md-5 col-form-label">{{ __('Escala fuerza muscular (DANIELS)') }}</label>
            <div class="col-md-7">
        ...
        <div class="form-header2"><h1 class="form-tittle2">{{ __('4. TEST DE ROMBERG') }}</h1></div>
        <div class="form-group row">
        ...
        <div class="form-header2"><h1 class="form-tittle2">{{ __('5. COORDINACIÓN') }}</h1></div>
        <div class="table-responsive">                    
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
        ...
        <div class="form-header2"><h1 class="form-tittle2">{{ __('6. CONTROL POSTURAL') }}</h1></div>
        <div class="form-group row">
        ...
        <div class="form-header2"><h1 class="form-tittle2">{{ __('7. ORTESIS O REQUERIMIENTOS PROTÉSICOS') }}</h1></div>
        <div class="form-group row">
        ...
        <div class="form-header2"><h1 class="form-tittle2">{{ __('8. MARCHA, LOCOMOCIÓN Y BALANCE') }}</h1></div>              
        <div class="table-responsive">                    
            <table class="table table-striped table-bordered">
                <thead>
                    <tr>
                ...
                <tbody>                        
                    ...
                    <tr>
                        ...
                        <td scope="col"><input type="radio" name="apoyo_medio__derecho" value="Normal"></td>
                        <td scope="col"><input type="radio" name="apoyo_medio__derecho" value="Anormal"></td>
