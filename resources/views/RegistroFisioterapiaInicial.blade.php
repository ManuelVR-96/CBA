        ...
        <div class="row justify-content-center">
            <div class="col-md-10">                
                ...
                <div class="form-group row">
                        ...
                        <div class="form-group row">
                            <label for="actividad_diaria" class="col-md-4 col-form-label text-md-right">{{ __('Actividades que le gusta realizar') }}</label>
                            <div class="col-md-6">
...
<tbody>
    ...
    <td scope="col"><input type="radio" name="desaceleracion_izquierdo" value="Anormal"></td>
        ...
        <div class="form-group row">
            <label for="marcha_observaciones" class="col-md-4 col-form-label text-md-right">{{ __('Observaciones') }}</label>
            <div class="col-md-6">
        ...
        <div class="form-group row">
            <label for="diagnostico_fisioterapeutico" class="col-md-4 col-form-label text-md-right">{{ __('Observaciones') }}</label>
            <div class="col-md-6">
        ...
        <div class="form-group row">
            <label for="conducta" class="col-md-4 col-form-label text-md-right">{{ __('Observaciones') }}</label>
            <div class="col-md-6">
