    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{route('delta.update', $nuevoCliente->id)}}">
                        @csrf
                        @Method('PUT')
        ...
        grave (por ejemplo: riesgo de suicidio, vagabundeó, síndrome de fuga.)</option>
                ...
                <div class="col-md-8">
                    ...
                    <option value="{{$delta->encargado_fisica}}">--------</option>
                        @foreach($encargados as $encargado)
                        <option value="{{$encargado->id}}">{{$encargado->nombres}}</option>
                        @endforeach()
                    ...
                    @enderror
                        ...
                        <div class="form-group row">
                <label for="encargado" class="col-md-3 col-form-label text-md-right">{{ __('Encargado Psíquica') }}</label>
                <div class="col-md-8">
