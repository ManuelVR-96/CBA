...
@section('content')
     ...
     <div class="panel panel-default">
          <div class="panel-body">
               <form action="{{route('valoraciones.eliminar', $user)}}" class="d-inline" method="POST">
                    @csrf
                    @method("DELETE")
                    <div class="form-horizontal">
                         <div class="col-sm-6">
                              <div class="form-group row">
                                   ...
                                   <div class="col-sm-6">
                                        <input type="text" class="form-control" value="{{$user->paciente}}">
                                   </div>
                              </div>
                               ...
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-6">
                                        <input type="text" class="form-control" value="{{$user->encargado}}">
                                   </div>
                              </div>
                               ...
                               <div class="form-group row">
                                   ...
                                   <div class="col-sm-6">
                                        <input type="date" class="form-control" value="{{$user->especialidad}}">
                                   </div>
                              </div>
                              ...
                              <div class="form-group row">
                                   ...
                                   <div class="col-sm-6">
                                        <input type="text" class="form-control" value="{{$user->descripción}}">
                                   </div>
                              </div>
