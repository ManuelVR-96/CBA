...
<div class="container">
    <div class="row justify-content-center">        
        ...
        <div class="card-header form-tittle_">Registro Valoración Gerontología de: --- {{$nuevoCliente->nombres}} {{$nuevoCliente->apellidos}} ---</div><br>
            @csrf
                                    
            <div class="form-header2"><h1 class="form-tittle2">{{ __('COGNICIÓN') }}</h1></div><br>
            <div class="form-group row">
                <label for="cognicion_uno" class="col-md-8 col-form-label">{{ __('Concentrarse en hacer algo durante diez minutos ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="cognicion_dos" class="col-md-8 col-form-label">{{ __(' Recordar las cosas importantes que tiene que hacer?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="cognicion_tres" class="col-md-8 col-form-label">{{ __(' Analizar y encontrar soluciones a los problemas de la vida diaria?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="cognicion_cuatro" class="col-md-8 col-form-label">{{ __('Aprender una nueva tarea, como por ejemplo llegar a un lugar nuevo ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="cognicion_cinco" class="col-md-8 col-form-label">{{ __('Entender en general lo que dice la gente?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="cognicion_seis" class="col-md-8 col-form-label">{{ __('Comenzar y mantener una conversación') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="movilidad_uno" class="col-md-8 col-form-label">{{ __('Estar de pie por largos periodos de tiempo como por ejemplo 30 minutos?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="movilidad_dos" class="col-md-8 col-form-label">{{ __('Pararse luego de estar sentado?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="movilidad_tres" class="col-md-8 col-form-label">{{ __(' Moverse dentro de su casa') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="movilidad_cuarto" class="col-md-8 col-form-label">{{ __('Salir de su casa ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="movilidad_cinco" class="col-md-8 col-form-label">{{ __(' Andar largas distancias, como un kilómetro [o algo equivalente]?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="autocuidado_uno" class="col-md-8 col-form-label">{{ __(' Lavarse todo el cuerpo (Bañarse) ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="autocuidado_dos" class="col-md-8 col-form-label">{{ __('Vestirse ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="autocuidado_tres" class="col-md-8 col-form-label">{{ __(' Comer?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="autocuidado_cuatro" class="col-md-8 col-form-label">{{ __(' Quedarse solo(a) durante unos días?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="relacionarse_uno" class="col-md-8 col-form-label">{{ __(' Relacionarse con personas que no conoce ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="relacionarse_dos" class="col-md-8 col-form-label">{{ __('Mantener una amistad ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="relacionarse_tres" class="col-md-8 col-form-label">{{ __('Llevarse bien con personas cercanas a usted ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="relacionarse_cuatro" class="col-md-8 col-form-label">{{ __('Hacer nuevos amigos?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="relacionarse_cinco" class="col-md-8 col-form-label">{{ __('Tener relaciones sexuales?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="quehacer_uno" class="col-md-8 col-form-label">{{ __(' Cumplir con sus quehaceres de la casa ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="quehacer_dos" class="col-md-8 col-form-label">{{ __(' Realizar bien sus quehaceres de la casa más importantes?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="quehacer_tres" class="col-md-8 col-form-label">{{ __(' Acabar sus quehaceres de la casa tan rápido como era necesario?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="quehacer_cuatro" class="col-md-8 col-form-label">{{ __(' Acabar todo el trabajo de la casa que tenía que hacer ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="quehacer_cinco" class="col-md-8 col-form-label">{{ __(' Llevar a cabo su trabajo diario?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="quehacer_seis" class="col-md-8 col-form-label">{{ __('Realizar bien las tareas más importantes de su trabajo?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="quehacer_siete" class="col-md-8 col-form-label">{{ __(' Acabar todo el trabajo que necesitaba hacer?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="quehacer_ocho" class="col-md-8 col-form-label">{{ __('Acabar su trabajo tan rápido como era necesario ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="participacion_uno" class="col-md-8 col-form-label">{{ __(' Cuánta dificultad ha tenido para participar, al mismo nivel que el resto de las personas, en actividades de la comunidad (por ejemplo, fiestas, actividades religiosas u otras actividades) ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="participacion_dos" class="col-md-8 col-form-label">{{ __('Cuánta dificultad ha tenido para vivir con dignidad (o respeto) debido a las actitudes y acciones de otras personas?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="participacion_tres" class="col-md-8 col-form-label">{{ __('Cuánta dificultad ha tenido para vivir con dignidad (o respeto) debido a las actitudes y acciones de otras personas?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="participacion_cuatro" class="col-md-8 col-form-label">{{ __(' Cuánto tiempo ha dedicado a su “condición de salud” o a las consecuencias de la misma?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="participacion_cinco" class="col-md-8 col-form-label">{{ __(' Cuánto le ha afectado emocionalmente su “condición de salud” ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="participacion_seis" class="col-md-8 col-form-label">{{ __('Qué impacto económico ha tenido para usted o para su familia su “condición de salud” ?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="participacion_siete" class="col-md-8 col-form-label">{{ __('Cuánta dificultad ha tenido su familia debido a su condición de salud?') }}</label>
                    <div class="col-md-4">
                ...
                <div class="form-group row">
                <label for="participacion_ocho" class="col-md-8 col-form-label">{{ __('Cuánta dificultad ha tenido para realizar por sí mismo(a) cosas que le ayuden a relajarse o disfrutar?') }}</label>
                    <div class="col-md-4">
